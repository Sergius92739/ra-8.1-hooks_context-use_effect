[![Build status](https://ci.appveyor.com/api/projects/status/7cx28p8w2e1qtse8/branch/master?svg=true)](https://ci.appveyor.com/project/Sergius92739/ra-8-1-hooks-context-use-effect/branch/master)

# Список и детали

### Deployment:  <a href="https://sergius92739.github.io/ra-8.1-hooks_context-use_effect/">Github Pages</a>
---
